...
export const useAllCheckboxesValues = ({ allCheckboxes, setAllCheckboxes, setFilters }: ProductsFiltersValuesI) => {
    ...
    const handleFiltersChange = (
        ...
        if (isSortedByPrice) {
          ...
          setFilters(prevFilters => ({
            ...prevFilters,
            price: `${e.currentTarget.checked && priceOrder}`,
          }))
        }
    
        setAllCheckboxes((prevCheckboxes) =>
          prevCheckboxes.map((checkbox) => {
            const setCheckboxesIsChecked = id === checkbox.id ? !checkbox.isChecked : false
