...
export const useProductsValues = (filters: IFilters) => {
    ...
    const sortedProducts = useMemo(() => {
        ...
        return sortedProductByCategory.sort(
            ...
            const determinedProductPrice = (filters.price === "ascending" ? currentProduct : nextProduct).price
            const determinedSubtractedProductPrize = (filters.price === "ascending" ? nextProduct : currentProduct).price
